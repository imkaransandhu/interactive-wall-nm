...
export default class Particles {
  ...
  init(src) {
    ...
    const newCanvas = document.getElementById("canvasToLoad");
    this.canvasVideo = document.getElementById("canvasVideo");

    
    removeBackground(video1, newCanvas);
    this.canvasVideo.src = newCanvas.toDataURL();
    //this.canvasVideo.load();
    this.canvasVideo.muted = true;
    this.canvasVideo.loop = true;
    this.canvasVideo.setAttribute("crossorigin", "anonymous");
    this.canvasVideo.addEventListener("canplay", () => {
      this.texture = new THREE.VideoTexture(this.canvasVideo);
      this.texture.minFilter = THREE.LinearFilter;
      this.texture.magFilter = THREE.LinearFilter;
      this.texture.format = THREE.RGBFormat;

      this.width = this.canvasVideo.videoWidth;
      this.height = this.canvasVideo.videoHeight;
